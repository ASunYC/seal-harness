const CACHE = "seal-harness-shell-v287";
...
SHELL.push("/tool-card.js?v=0.3.4-4", "/review-view.js?v=0.3.4-2", "/subagent-tree.js?v=0.3.4-1", "/child-transcript.js?v=0.3.4-6", "/child-history.js?v=0.3.4-1", "/app.js?v=0.3.4-216", "/styles.css?v=0.3.4-115", "/transcript-view.js?v=0.3.4-5", "/history-window.js?v=0.3.4-1");

self.addEventListener("install", (event) => {
  SHELL.push("/session-search.js?v=0.3.4-6", "/app.js?v=0.3.4-237", "/stream-sequence.js?v=0.3.4-5", "/tool-card.js?v=0.3.4-6", "/styles.css?v=0.3.4-119", "/transcript-view.js?v=0.3.4-8", "/child-transcript.js?v=0.3.4-11", "/child-history.js?v=0.3.4-4", "/subagent-tree.js?v=0.3.4-2");
  SHELL.push("/compaction-activity.js?v=0.3.4-1", "/app.js?v=0.3.4-241", "/stream-sequence.js?v=0.3.4-6", "/transcript-view.js?v=0.3.4-9", "/styles.css?v=0.3.4-120", "/app.js?v=0.3.4-230", "/queue-dock.js?v=0.3.4-10");
  SHELL.push("/styles.css?v=0.3.4-117", "/app.js?v=0.3.4-228", "/stream-sequence.js?v=0.3.4-4", "/child-history.js?v=0.3.4-3", "/transcript-view.js?v=0.3.4-6", "/i18n.js?v=0.3.4-76", "/child-transcript.js?v=0.3.4-7", "/tool-card.js?v=0.3.4-5");
